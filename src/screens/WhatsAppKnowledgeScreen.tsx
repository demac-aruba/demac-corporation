...
const styles = StyleSheet.create({
  ...
  infoBox: { borderWidth: 1, borderColor: colors.border, borderRadius: 12, padding: 14, gap: 5, backgroundColor: colors.surfaceAlt },
  ...
  toggle: { borderWidth: 1, borderColor: colors.border, borderRadius: 999, paddingHorizontal: 14, paddingVertical: 8, backgroundColor: colors.surfaceAlt },
  ...
  languageGrid: { gap: 12 },
  exceptionToggle: { marginTop: 14, borderWidth: 1, borderColor: colors.border, borderRadius: 12, padding: 12, gap: 4, backgroundColor: colors.surfaceAlt },
