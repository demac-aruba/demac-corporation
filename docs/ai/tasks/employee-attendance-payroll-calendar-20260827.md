...
Implementation branch: `fix/employee-attendance-payroll-calendar-20260827`
...
- Changes to Sunday/office/technician recurring schedule ownership.
...
- Technical recurring half-day: `vanHalfDaySchedules`.
...
- existing `npm run test:employee-schedule --prefix apps/erp-next`
