...
| Equipment / assets | Legacy equipment flows under `src` | ERP Next field-asset and CRM asset work exists | Canonical Site/Property Asset identity and work-order linkage | PARTIAL | Field Operations / CRM | `docs/ERP_NEXT_FIELD_ASSETS_V1.md`; reviewed 2026-08-23 |
...
| Inventory | Legacy inventory flows under `src` | ERP Next ledger, van, transfer, and readiness work exists | Inventory Authority over transaction ledger | PARTIAL | Inventory / Warehouse | `docs/ERP_NEXT_INVENTORY_*`; reviewed 2026-08-23 |
