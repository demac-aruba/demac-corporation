...
function reportProjectionFromStored(storedRecord, projectedIntervention) {
  ...
  return {
    ...
    ...(storedRecord.dwellingId ? { dwellingId: storedRecord.dwellingId } : {}),
    ...(storedRecord.areaId ? { areaId: storedRecord.areaId } : {}),
    ...(storedRecord.locationSnapshot ? { locationSnapshot: storedRecord.locationSnapshot } : {}),
