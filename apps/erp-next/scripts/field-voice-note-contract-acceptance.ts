...
const baseJob = {
  ...
  allowedActions: ['read', 'execute', 'evidence.add', 'report.edit', 'intervention.complete'], fieldVisit: visit, canPrepareVisit: false, knownEquipment: [], visitAssets: [visitAsset], canAddExistingAsset: true,
