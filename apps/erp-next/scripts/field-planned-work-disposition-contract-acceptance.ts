...
const baseJob = {
  ...
  allowedActions: ['read', 'execute', 'asset.add', 'intervention.add', 'intervention.complete'], fieldVisit: visit, canPrepareVisit: false, canCreateReturnVisit: false, knownEquipment: [], visitAssets: [], canAddExistingAsset: true,
