...
export function FieldPartSelector({ target, equipmentLabel, equipmentDescription, onBack }: {
  target: FieldProcedureTarget; equipmentLabel: string; equipmentDescription: string; onBack: () => void;
}) {
  ...
  return <PartSelectorSession key={identityKey} target={target} equipmentLabel={equipmentLabel} equipmentDescription={equipmentDescription} onBack={onBack} />;
}
function PartSelectorSession({ target, equipmentLabel, equipmentDescription, onBack }: {
  target: FieldProcedureTarget; equipmentLabel: string; equipmentDescription: string; onBack: () => void;
}) {
